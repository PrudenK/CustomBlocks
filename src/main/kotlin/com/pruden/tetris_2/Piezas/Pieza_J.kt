...
class Pieza_J (override var fila: Int, override var columna: Int,
    ...
    private val CENTRO = 58
    private val NUMPIEZA = 5
    private val COLOR = Color.ORANGE

    private val FORMAS_J = arrayOf(
        arrayOf(
    ...
    companion object {
        const val NUMPIEZA_J = 5
        const val CENTRO_J = 58
        val COLOR_J = Color.ORANGE!!
    }
    ...
    override fun derecha(): Boolean {
       return moverDerechaIzquierda_3x2(this, intArrayOf(2, 0, 2, 2, 2, 1, 1, 1, 1, 1), 1)
    }

    override fun izquierda(): Boolean {
       return moverDerechaIzquierda_3x2(this, intArrayOf(-2, -2, -2, 0, -1, -1, -1, -1, -1, -2), -1)
    }
    ...
    override fun clonar(): Piezas {
        return Pieza_J(this.fila, this.columna)
    }
}