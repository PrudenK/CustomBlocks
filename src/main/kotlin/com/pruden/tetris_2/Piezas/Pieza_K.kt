...
class Pieza_K (override var fila: Int, override var columna: Int) : Piezas(fila, columna) {
    ...
    override fun derecha() {
        moverDerechaIzquierda_3x3(this, intArrayOf(0, 2, 1, 1, 0, 2, 0, 2, 2, 2, 0, 2, 2, 2, 1, 1, 0, 2, 0, 2, 1, 1, 2, 2),1)
    }

    override fun izquierda() {
        moverDerechaIzquierda_3x3(this, intArrayOf(0, -2, -2, -2, 0, -2, 0, -2, -1, -1, 0, -2, -2, -2, -1, -1, 0, -2, 0, -2, -1, -1, -2, -2),-1)
    }
