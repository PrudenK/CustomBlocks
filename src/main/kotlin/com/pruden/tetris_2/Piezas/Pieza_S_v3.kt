...
class Pieza_S_v3 (override var fila: Int, override var columna: Int,
    ...
    private val CENTRO = 518
    private val NUMPIEZA = 51
    private val COLOR =  Color.web("#d1f3c5")

    private val FORMAS_S_v3 = arrayOf(
        arrayOf(
    ...
    companion object {
        const val NUMPIEZA_S_v3 = 51
        const val CENTRO_S_v3 = 518
        val COLOR_S_v3 =  Color.web("#d1f3c5")!!
    }
    ...
    override fun bajar(): Boolean {
        return bajar5x3(this, intArrayOf(1,1,1,1,2,   -7,-7,-7,-7,-7,   3,3,3,3,3,3,-1,-1,-1))
    }
    ...
    override fun clonar(): Pieza {
        return Pieza_S_v3(this.fila, this.columna)
    }
}