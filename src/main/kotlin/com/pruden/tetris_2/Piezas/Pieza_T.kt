...
class Pieza_T (override var fila: Int, override var columna: Int) : Piezas(fila, columna) {
    ...
    override fun derecha() {
        moverDerechaIzquierda_3x2(this, intArrayOf(2, 1, 2, 1, 1, 2, 1, 1, 1, 1), 1)
    }

    override fun izquierda() {
        moverDerechaIzquierda_3x2(this, intArrayOf(-2, -1, -2, -1, -1, -1, -1, -1, -2, -1), -1)
    }
