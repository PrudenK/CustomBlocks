...
class Pieza_Y  (override var fila: Int, override var columna: Int) : Piezas(fila, columna) {
        ...
        return if (nuevaOrientacion == 0) {
            if (matrizNumerica[filaCentro - 1][columnaCentro + 1] == BLANCO 
                ...
                if (matrizNumerica[filaCentro + 1][columnaCentro] != BLANCO) {
                    condicionRotar_especial( -1, 0, -2, -1, -2, 1, false, -1)
                } else condicionRotar_especial( 0, -1, 0, -1, -2, -1, true, -1)
            }
            ...
            if (matrizNumerica[filaCentro][columnaCentro - 1] == BLANCO
                ...
                if (matrizNumerica[filaCentro + 1][columnaCentro + 1] != BLANCO) {
                    condicionRotar_especial( -1, 0, 0, -1, 0, -2, true, -1)
                } else condicionRotar_especial( 0, 1, -1, 2, 1, 2, true, 1)
            }
            ...
            if (matrizNumerica[filaCentro - 1][columnaCentro] == BLANCO
                ...
                if (matrizNumerica[filaCentro + 1][columnaCentro - 1] != BLANCO) {
                    condicionRotar_especial( 0, 1, 1, 0, 2, 0, false, -1)
                } else condicionRotar_especial( 1, 0, 2, -1, 2, 1, false, 1)
            }
        } else {
            if (matrizNumerica[filaCentro - 1][columnaCentro - 1] == BLANCO
                ...
                if (matrizNumerica[filaCentro][columnaCentro + 1] != BLANCO) {
                    condicionRotar_especial( 0, -1, -1, -2, 1, -2, true, -1)
                } else condicionRotar_especial( 1, 0, 0, 1, 0, 2, true, 1)
            }
        }
    }
