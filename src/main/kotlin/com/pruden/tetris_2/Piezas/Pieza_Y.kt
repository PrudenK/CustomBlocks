...
class Pieza_Y (override var fila: Int, override var columna: Int,
    ...
    private val CENTRO = 278
    private val NUMPIEZA = 27
    private val COLOR = Color.web("#d67dff")

    private val FORMAS_Y = arrayOf(
        arrayOf(
    ...
    companion object {
        const val NUMPIEZA_Y = 27
        const val CENTRO_Y = 278
        val COLOR_Y = Color.web("#d67dff")!!
    }
        ...
        return if (nuevaOrientacion == 0) {
            if (matrizNumerica[filaCentro - 1][columnaCentro + 1] == BLANCO 
                ...
                if (matrizNumerica[filaCentro + 1][columnaCentro] != BLANCO) {
                    condicionRotarEspecial(this,intArrayOf(-1, -2, -2),intArrayOf(0, -1, 1), false, -1)
                } else condicionRotarEspecial(this,intArrayOf(0, 0, -2),intArrayOf(-1, -1, -1), true, -1)
            }
            ...
            if (matrizNumerica[filaCentro][columnaCentro - 1] == BLANCO
                ...
                if (matrizNumerica[filaCentro + 1][columnaCentro + 1] != BLANCO) {
                    condicionRotarEspecial(this,intArrayOf(-1, 0, 0),intArrayOf(0, -1, -2), true, -1)
                } else condicionRotarEspecial(this,intArrayOf(0, -1, 1),intArrayOf(1, 2, 2), true, 1)
            }
            ...
            if (matrizNumerica[filaCentro - 1][columnaCentro] == BLANCO
                ...
                if (matrizNumerica[filaCentro + 1][columnaCentro - 1] != BLANCO) {
                    condicionRotarEspecial(this,intArrayOf(0, 1, 2),intArrayOf(1, 0, 0), false, -1)
                } else condicionRotarEspecial(this,intArrayOf(1, 2, 2),intArrayOf(0, -1, 1), false, 1)
            }
        } else {
            if (matrizNumerica[filaCentro - 1][columnaCentro - 1] == BLANCO
                ...
                if (matrizNumerica[filaCentro][columnaCentro + 1] != BLANCO) {
                    condicionRotarEspecial(this,intArrayOf(0, -1, 1),intArrayOf(-1, -2, -2), true, -1)
                } else condicionRotarEspecial(this,intArrayOf(1, 0, 0),intArrayOf(0, 1, 2), true, 1)
            }
        }
    }

    override fun bajar(): Boolean {
        return bajar3x3(this, intArrayOf(0, 0, 2, 2, 0, 0, 2, 2, 1, 1, 2, 2, 1, 1, 1, 1, 0, 2, 0, 2, 1, 1, 1, 1))
    }

    override fun derecha(): Boolean {
       return moverDerechaIzquierda_3x3(this, intArrayOf(0, 2, 1, 1, 1, 1, 1, 1, 1, 1, 0, 2, 2, 2, 1, 1, 2, 2, 0, 0, 2, 2, 0, 0), 1)
    }

    override fun izquierda(): Boolean {
       return moverDerechaIzquierda_3x3(this, intArrayOf(0, -2, -1, -1, -1, -1, -1, -1, -1, -1, 0, -2, 0, 0, -2, -2, 0, 0, -2, -2, -1, -1, -2, -2), -1)
    }
    ...
    override fun clonar(): Piezas {
        return Pieza_Y(this.fila, this.columna)
    }
}