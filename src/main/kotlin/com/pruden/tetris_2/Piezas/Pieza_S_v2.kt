...
class Pieza_S_v2 (override var fila: Int, override var columna: Int) : Piezas(fila, columna) {
        ...
        return if (nuevaOrientacion == 0) {
            ...
            if (matrizNumerica[filaCentro - 1][columnaCentro - 1] == BLANCO
                ...
                true
                    ...
                    condicionRotar_especial( 0, 1, 0, 2, 1, 2, true, 1)
        }
    }
    ...
    override fun derecha() {
        moverDerechaIzquierda_3x3(this, intArrayOf(2,2, 1,1, 1,1, 2,2, 1,1, 1,1, 0,0, 2,2, 2,2, 0,0, 2,2, 2,2), 1)
    }

    override fun izquierda() {
        moverDerechaIzquierda_3x3(this, intArrayOf(-1,-1, -1,-1, -2,-2, -1,-1, -1,-1, -2,-2, -2,-2, -2,-2,0, 0, -2,-2, -2,-2,0, 0), -1)
    }
