...
class Pieza_S_v2 (override var fila: Int, override var columna: Int,
    ...
    private val CENTRO = 208
    private val NUMPIEZA = 20
    private val COLOR = Color.SEAGREEN

    private val FORMAS_S_v2 = arrayOf(
        arrayOf(
    ...
    companion object {
        const val NUMPIEZA_S_v2 = 20
        const val CENTRO_S_v2 = 208
        val COLOR_S_v2 = Color.SEAGREEN!!
    }
        ...
        return if (nuevaOrientacion == 0) {
            ...
            if (matrizNumerica[filaCentro - 1][columnaCentro - 1] == BLANCO
                ...
                true
                    ...
                    condicionRotarEspecial(this,intArrayOf(0, 0, 1),intArrayOf(1, 2, 2), true, 1)
        }
    }

    override fun bajar(): Boolean {
        return bajar3x3(this, intArrayOf(2, 2,2, 2,0, 0,2, 2,2, 2,0, 0,1, 1,1, 1,2, 2,1, 1,1, 1,2, 2))
    }

    override fun derecha(): Boolean {
       return moverDerechaIzquierda_3x3(this, intArrayOf(2,2, 1,1, 1,1, 2,2, 1,1, 1,1, 0,0, 2,2, 2,2, 0,0, 2,2, 2,2), 1)
    }

    override fun izquierda(): Boolean {
       return moverDerechaIzquierda_3x3(this, intArrayOf(-1,-1, -1,-1, -2,-2, -1,-1, -1,-1, -2,-2, -2,-2, -2,-2,0, 0, -2,-2, -2,-2,0, 0), -1)
    }
    ...
    override fun clonar(): Pieza {
        return Pieza_S_v2(this.fila, this.columna)
    }
}