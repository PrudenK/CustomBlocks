...
class Pieza_A (override var fila: Int, override var columna: Int) : Piezas(fila, columna) {
        ...
        return if (nuevaOrientacion == 0) {
            if (matrizNumerica[filaCentro][columnaCentro + 1] == BLANCO
                ...
                true
                    ...
                    || condicionRotar_especial( 0, 1, -1, -1, -2, 0, false, -1))
            ...
            if (matrizNumerica[filaCentro - 1][columnaCentro - 1] == BLANCO
                ...
                if (matrizNumerica[filaCentro + 1][columnaCentro] != BLANCO) {
                    condicionRotar_especial( -1, 1, -2, -1, -2, 0, false, -1)
                } else condicionRotar_especial( 1, -1, -1, 0, 0, 1, true, 1) ||
                        condicionRotar_especial( 2, -1, 2, 0, 1, 0, true, 1)
            }
            ...
            if (matrizNumerica[filaCentro - 1][columnaCentro] == BLANCO
                && matrizNumerica[filaCentro + 1][columnaCentro + 1] == BLANCO) {
                true
            } else condicionRotar_especial( -1, 0, 0, -2, 1, -1, true, -1) ||
                    condicionRotar_especial( -2, 1, -2, 0, -1, 0, false, -1)
        }
    }
