...
class Pieza_W (override var fila: Int, override var columna: Int,
    ...
    override fun derecha() {
        moverDerechaIzquierda_3x3(this, intArrayOf(0,0, 1,1, 2,2, 1,1, 2,2, 2,2, 2,2, 1,1, 0,0, 2,2, 2,2, 1,1), 1)
    }

    override fun izquierda() {
        moverDerechaIzquierda_3x3(this, intArrayOf(-2,-2, -2,-2, -1,-1, -2,-2, -1,-1, 0,0, -1,-1, -2,-2, -2,-2, 0,0, -1,-1, -2,-2), -1)
    }
