...
class Pieza_W (override var fila: Int, override var columna: Int,
    ...
    private val CENTRO = 128
    private val NUMPIEZA = 12
    private val COLOR = Color.DEEPPINK

    private val FORMAS_W = arrayOf(
        arrayOf(
    ...
    companion object {
        const val NUMPIEZA_W = 12
        const val CENTRO_W = 128
        val COLOR_W = Color.DEEPPINK!!
    }
    ...
    override fun derecha(): Boolean {
       return moverDerechaIzquierda_3x3(this, intArrayOf(0,0, 1,1, 2,2, 1,1, 2,2, 2,2, 2,2, 1,1, 0,0, 2,2, 2,2, 1,1), 1)
    }

    override fun izquierda(): Boolean {
       return moverDerechaIzquierda_3x3(this, intArrayOf(-2,-2, -2,-2, -1,-1, -2,-2, -1,-1, 0,0, -1,-1, -2,-2, -2,-2, 0,0, -1,-1, -2,-2), -1)
    }
