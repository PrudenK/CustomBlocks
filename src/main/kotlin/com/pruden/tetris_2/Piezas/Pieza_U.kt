...
class Pieza_U (override var fila: Int, override var columna: Int,
    ...
    override fun derecha(): Boolean {
       return moverDerechaIzquierda_3x3(this, intArrayOf(0, 2, 2, 2, -7, -7, -7, -7, 2, 2, 2, 0, 2, 2, 1, 1, 2, 2, 1, 1, 1, 1, 1, 1), 1)
    }

    override fun izquierda(): Boolean {
       return moverDerechaIzquierda_3x3(this, intArrayOf(0, -2, -2, -2, -7, -7, -7, -7, -2, -2, -2, 0, -1, -1, -1, -1, -1, -1, -2, -2, -1, -1, -2, -2), -1)
    }
    ...
    override fun clonar(): Pieza {
        return Pieza_U(this.fila, this.columna)
    }
}