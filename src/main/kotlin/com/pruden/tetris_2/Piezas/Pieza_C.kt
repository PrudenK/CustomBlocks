...
class Pieza_C (override var fila: Int, override var columna: Int,
    ...
    override fun derecha() {
        moverDerechaIzquierda_3x3(this, intArrayOf(0, 2, 0, 2, 2, 2, 2, 2, 0, 2, 0, 2, 2, 2, 0, 0, 2, 2, 2, 2, 2, 2, 2, 2), 1)
    }

    override fun izquierda() {
        moverDerechaIzquierda_3x3(this, intArrayOf(0, -2, 0, -2, -2, -2, -2, -2, 0, -2, 0, -2, -2, -2, -2, -2, -2, -2, -2, -2, 0, 0, -2, -2), -1)
    }
