...
class Pieza_L (override var fila: Int, override var columna: Int,
        ...
        return if (nuevaOrientacion == 0) {
            ...
            if (filaCentro != Globales.FILAS - 1) {
                if (matrizNumerica[filaCentro - 1][columnaCentro] == BLANCO
                    ...
                    true
                } else condicionRotarEspecial(this,intArrayOf(-2, -1),intArrayOf(0, 0), false, -1)
            } else condicionRotarEspecial(this,intArrayOf(-2, -1),intArrayOf(0, 0), false, -1)
    ...
    override fun derecha(): Boolean {
       return moverDerechaIzquierda_3x2(this, intArrayOf(2, 2, 2, 0, 1, 1, 2, 1, 1, 1), 1)
    }

    override fun izquierda(): Boolean {
       return moverDerechaIzquierda_3x2(this, intArrayOf(-2, 0, -2, -2, -1, -1, -1, -2, -1, -1), -1)
    }
    ...
    override fun clonar(): Piezas {
        return Pieza_L(this.fila, this.columna)
    }
}