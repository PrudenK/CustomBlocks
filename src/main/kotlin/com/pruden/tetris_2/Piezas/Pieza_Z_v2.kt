...
class Pieza_Z_v2 (override var fila: Int, override var columna: Int,
    ...
    private val CENTRO = 168
    private val NUMPIEZA = 16
    private val COLOR = Color.SILVER

    private val FORMAS_Z_v2 = arrayOf(
        arrayOf(
    ...
    companion object {
        const val NUMPIEZA_Z_v2 = 16
        const val CENTRO_Z_v2 = 168
        val COLOR_Z_v2 = Color.SILVER!!
    }
    ...
    override fun clonar(): Pieza {
        return Pieza_Z_v2(this.fila, this.columna)
    }
}