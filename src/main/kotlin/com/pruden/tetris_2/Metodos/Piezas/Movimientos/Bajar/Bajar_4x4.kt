...
fun bajar4x4(pieza: Piezas, desplazamientos: IntArray): Boolean {
    with(pieza) {
        ...
        if (orientacion == 0) {
            puedeBajar =
                matrizNumerica[getFilaCentro() + desplazamientos[0]][getColumnaCentro() - 1] == BLANCO
                        ...
                        && matrizNumerica[getFilaCentro() + desplazamientos[3]][getColumnaCentro()] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[4]][getColumnaCentro() + 1] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[5]][getColumnaCentro() + 1] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[6]][getColumnaCentro() + 2] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[7]][getColumnaCentro() + 2] == BLANCO
        } else if (orientacion == 2) {
            puedeBajar =
                matrizNumerica[getFilaCentro() + desplazamientos[8]][getColumnaCentro() - 2] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[9]][getColumnaCentro() - 2] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[10]][getColumnaCentro() - 1] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[11]][getColumnaCentro() - 1] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[12]][getColumnaCentro()] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[13]][getColumnaCentro()] == BLANCO
            ...
            puedeBajar =
                matrizNumerica[getFilaCentro() + desplazamientos[16]][getColumnaCentro() - 2] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[17]][getColumnaCentro() - 2] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[18]][getColumnaCentro() - 1] == BLANCO
                        && matrizNumerica[getFilaCentro() + desplazamientos[19]][getColumnaCentro() - 1] == BLANCO
            ...
            puedeBajar = matrizNumerica[getFilaCentro() + desplazamientos[24]][getColumnaCentro() - 1] == BLANCO
                    ...
                    && matrizNumerica[getFilaCentro() + desplazamientos[28]][getColumnaCentro() + 1] == BLANCO
                    && matrizNumerica[getFilaCentro() + desplazamientos[29]][getColumnaCentro() + 1] == BLANCO
                    && matrizNumerica[getFilaCentro() + desplazamientos[30]][getColumnaCentro() + 2] == BLANCO
                    && matrizNumerica[getFilaCentro() + desplazamientos[31]][getColumnaCentro() + 2] == BLANCO
        }
        if (puedeBajar) {
            limpiar()
            fila = (fila + 1)
