...
object Stages {
    ...
    val SUSCRIPCIONES = ClaseStage("Vistas/Suscripciones/vistaSuscripciones.fxml", cPrin.nuevaPartidaB, 383.0, 416.0, null, 0, 0)
    val LOGROS = ClaseStage("Vistas/Logros/vistaLogros.fxml", cPrin.nuevaPartidaB, 676.0, 727.0, null, 0, 0)
    val PARTIDAS_GUARDADAS = ClaseStage("Vistas/Partidas/vistaPartidasGuardadas.fxml", cPrin.nuevaPartidaB, 610.0, 420.0, null, 0, -60)
    ...
    val HISTORIAL_PARTIDAS_PVP = ClaseStage("Vistas/PVP/vistaHistorialPVP.fxml", cPrin.nuevaPartidaB, 660.0, 529.0, null, 0, 0)
