...
object Listas {
    ...
    val LISTA_STAGES_MODOS_DE_JUEGOS = listOf(
        ClaseStage("Vistas/Modos/vista_Modo_Clasico.fxml", ControladorModosJuego.cModosJuego.jugar,700.0,694.0, null,0, 0),
        ClaseStage("Vistas/Modos/vista_Modo_ClasicoV2.fxml", ControladorModosJuego.cModosJuego.jugar,700.0,694.0, null,0, 0),
        ClaseStage("Vistas/Modos/vista_Modo_Todo.fxml", ControladorModosJuego.cModosJuego.jugar,700.0,694.0, null,0, 0),
        ClaseStage("Vistas/Modos/vista_Modo_Algebra.fxml", ControladorModosJuego.cModosJuego.jugar,700.0,694.0, null,0, 0),
        ClaseStage("Vistas/Modos/vista_Modo_RapidO.fxml", ControladorModosJuego.cModosJuego.jugar,700.0,694.0, null,0, 0),
        ClaseStage("Vistas/Modos/vista_Modo_Memory.fxml", ControladorModosJuego.cModosJuego.jugar,700.0,694.0, null,0, 0),
        ClaseStage("Vistas/Modos/vista_Modo_MemoryX.fxml", ControladorModosJuego.cModosJuego.jugar,700.0,694.0, null,0, 0),
        ClaseStage("Vistas/Modos/vista_Modo_MemoryY.fxml", ControladorModosJuego.cModosJuego.jugar,700.0,694.0, null,0, 0)
    )
